...
echo -e "  \033[33m <https://github.com/CRUSTDE-ContainerizedRustDevEnv/crustde_cnt_img_pod/blob/main/ssh_easy.md> \033[0m"
...
cat ~/.ssh/config | grep -q "~/.ssh/crustde_rustdevuser_ssh_1" || echo -e "  \033[31m The ~/.ssh/config does not contain the identity ~/.ssh/crustde_rustdevuser_ssh_1. \033[0m"
